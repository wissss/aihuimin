        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row  border-bottom white-bg dashboard-header">
                ...
                {{--<div class="col-sm-3">
                    ...
                    <br>
                    <br>
                    <img src="style/img/qr_code.png" width="100%" style="wrapper wrapper-content">
                    <br>
                </div>--}}
                {{--<div class="col-sm-5">--}}
                    {{--<h2>--}}
                            ...
                            {{--<div class="col-lg-4">--}}
                                {{--<div class="ibox float-e-margins">--}}
                                    ...
                                    {{--<div class="ibox-content">--}}
                                        ...
                                        {{--</div>--}}
                                        {{--<p>--}}
                                            {{--<img src="style/img/alipay_qr_code.png" width="100%" style="max-width:369px">--}}
                                        {{--</p>--}}
                                                        ...
                                                        {{--<div class="panel-body">--}}
                                                            {{--<ol>--}}
                                                                ...
                                                                {{--<li>增加--}}
                                                                    ...
                                                                    {{--<a href="chat_view.html">聊天窗口</a>等页面；--}}
                                                                {{--</li>--}}
