...
<head>
    ...
    <title>HDHM_HOME - 图片上传</title>
    <meta name="keywords" content="HDHM_HOME - 图片上传">
    <meta name="description" content="HDHM_HOME - 图片上传">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form id="my-awesome-dropzone" class="dropzone" action="{{URL("file_upload")}}" method="post" >
                                    <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                                    <div class="dropzone-previews"></div>
                                    <button type="submit" class="btn btn-primary pull-right">提交</button>
                                </form>
                                <div>
                                    <div class="m">请主人选择照片上传  :: <font color="#f71711" size="3">按住电脑键盘上的Ctrl + 鼠标左键选择 可以实现多张图片上传 </font></div>
                                </div>
                            </div>
                        </div>
                    </div>
